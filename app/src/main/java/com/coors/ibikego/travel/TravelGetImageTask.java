 ...
 */
public class TravelGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "TravelGetImageTask";
    private final static String ACTION = "getImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    public TravelGetImageTask(ImageView imageView) {
