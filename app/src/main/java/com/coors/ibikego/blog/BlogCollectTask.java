 ...
 */
public class BlogCollectTask  extends AsyncTask<Object,Integer,String> {
    private final static String TAG = "BikeCollectTask";
    private String ACTION = "collectOneBlog";
