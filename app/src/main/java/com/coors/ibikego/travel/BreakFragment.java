...
public class BreakFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.setAdapter(new BreakAdapter(inflater));
        return view;
    }


    private class BreakAdapter extends RecyclerView.Adapter<BreakAdapter.ViewHolder> {
        private LayoutInflater inflater;
        public BreakAdapter(LayoutInflater inflater) {
